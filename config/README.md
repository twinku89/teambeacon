...
- `JIRA_SECURITY_CREATE_SAMPLE_KEY` (default: `REV-5404`; Security Insights create-ticket template source)
- `JIRA_SECURITY_CREATE_PROJECT_ID` and `JIRA_SECURITY_CREATE_ISSUE_TYPE_ID` (fallback template IDs used if the sample issue is unavailable)
- `JIRA_SECURITY_CREATE_ISSUE_TYPE_NAME` (fallback issue type selector; default: `Story`)
